...
from flag_gems.ops.bitwise_and import bitwise_and_scalar as _fallback_bitwise_and_scalar
from flag_gems.ops.bitwise_and import (
    bitwise_and_scalar_ as _fallback_bitwise_and_scalar_,
)
from flag_gems.ops.bitwise_and import (
    bitwise_and_scalar_tensor as _fallback_bitwise_and_scalar_tensor,
)
from flag_gems.ops.bitwise_and import bitwise_and_tensor as _fallback_bitwise_and_tensor
from flag_gems.ops.bitwise_and import (
    bitwise_and_tensor_ as _fallback_bitwise_and_tensor_,
)
...
@libentry()
@triton.jit
def _bitwise_and_tensor_contig_kernel(
    a,
    b,
    out,
    n_elements,
...
@libentry()
@triton.jit
def _bitwise_and_tensor_contig_nomask_kernel(
    a,
    b,
    out,
    n_elements,
...
def _bitwise_and_scalar_contig_kernel(
    a,
    value,
    out,
    n_elements,
...
@libentry()
@triton.jit(do_not_specialize=["value"])
def _bitwise_and_scalar_contig_nomask_kernel(
    a,
    value,
    out,
    n_elements,
...
def _launch_tensor(a, b, out):
    ...
    if n_elements % block_size == 0:
        _bitwise_and_tensor_contig_nomask_kernel[grid](
            a, b, out, n_elements, BLOCK_SIZE=block_size
        )
    else:
        _bitwise_and_tensor_contig_kernel[grid](
            a, b, out, n_elements, BLOCK_SIZE=block_size
        )
    return out
...
def _launch_scalar(a, value, out):
    ...
    grid = _launch_grid(n_elements, block_size)
    if n_elements % block_size == 0:
        _bitwise_and_scalar_contig_nomask_kernel[grid](
            a, int(value), out, n_elements, BLOCK_SIZE=block_size
        )
    else:
        _bitwise_and_scalar_contig_kernel[grid](
            a, int(value), out, n_elements, BLOCK_SIZE=block_size
        )
    return out
...
def bitwise_and_tensor(A, B):
    ...
    return _fallback_bitwise_and_tensor(A, B)
...
def bitwise_and_tensor_(A, B):
    ...
    return _fallback_bitwise_and_tensor_(A, B)
...
def bitwise_and_scalar(A, B):
    ...
    return _fallback_bitwise_and_scalar(A, B)
...
def bitwise_and_scalar_(A, B):
    ...
    return _fallback_bitwise_and_scalar_(A, B)
...
def bitwise_and_scalar_tensor(A, B):
    ...
    return _fallback_bitwise_and_scalar_tensor(A, B)
